...
## Files You'll Need
1. **nectiv-email-template-v2.html** - The main template (one-time setup)
...
1. Open `nectiv-email-template-v2.html` in a text editor
...
- [ ] 5 AI/GEO news items with links
- [ ] 3 SEO insights or tips
- [ ] 1 featured tool to spotlight
- [ ] 3 resources or guides to share
- [ ] Any special announcements

### Step 3: Add Your Weekly Content
1. Open `weekly-content-template.html` in a text editor
2. Replace all `[BRACKETS]` with your actual content:
   - Search for `[` to find all placeholders
   - Replace headlines, descriptions, and links
...
[NEWS HEADLINE 1] → "Google Launches New AI Overview Features for B2B Queries"
[NEWS DESCRIPTION 1] → "Google's latest update prioritizes B2B content in AI overviews, creating new opportunities for enterprise SEO strategies."
[LINK-URL-1] → "https://example.com/article"
```
...
- `[FEATURE 1/2/3]` - Key features or benefits
- `[PRICING INFO]` - Free, paid, or price range
- `[TOOL-LINK]` - Link to the tool
- `[CTA TEXT]` - "Try It Free", "Learn More", etc.
...
<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
    <tr>
        <td>
            <h2 style="border-bottom: 3px solid #0066FF; color: #1a1a1a; font-size: 20px; font-weight: 700; margin-bottom: 20px; padding-bottom: 10px; font-family: Arial, sans-serif;">
